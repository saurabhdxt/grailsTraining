			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="companyProperties" title="${message(code: 'company.companyProperties.label', default: 'Company Properties')}" />
					
						<g:sortableColumn property="field" title="${message(code: 'company.field.label', default: 'Field')}" />
				...
				<g:each in="${companyInstanceList}" status="i" var="companyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: companyInstance, field: "companyProperties")}</td>
					
						<td>${fieldValue(bean: companyInstance, field: "field")}</td>
