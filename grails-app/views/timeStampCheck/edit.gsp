...
<html>
	...
	<body>
		<a href="#edit-timeStampCheck" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-timeStampCheck" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${timeStampCheckInstance?.version}" />
				<fieldset class="form">
